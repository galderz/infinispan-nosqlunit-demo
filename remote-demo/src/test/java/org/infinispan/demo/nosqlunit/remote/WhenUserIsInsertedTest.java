package org.infinispan.demo.nosqlunit.remote;
...
public class WhenUserIsInsertedTest {

   @ClassRule
   public static final ManagedInfinispan MANAGED_INFINISPAN =
         newManagedInfinispanRule().infinispanPath("/opt/infinispan-server").build();
